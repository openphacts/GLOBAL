...
problems_22="$HOME/gh/openphacts/GLOBAL/issues/2.2/problem-calls-encoded.csv"
ops4j_22="$HOME/gh/openphacts/GLOBAL/issues/2.2/ops4j-calls-encoded.csv"
defaults_22="$HOME/gh/openphacts/GLOBAL/issues/2.2/default-calls-encoded.csv"

problems_file="${1:-$problems_22}"
...
#    "http://alpha.openphacts.org:3004"
    "http://fiennes.data2discovery.net:3004"
)

declare -a sparqls=(
#    "http://beta.openphacts.org:3003/sparql"
#    "http://alpha.openphacts.org:8890/sparql"
    "http://fiennes.data2discovery.net:8890/sparql"
)
